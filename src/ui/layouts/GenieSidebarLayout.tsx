...
function UsageComponent() {
  return (
    <div className="px-6 py-6 border-t border-gray-200 bg-gradient-to-br from-emerald-50 to-emerald-100">
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="text-emerald-700 font-bold">7,000 / 10,000</span>
          </div>
        ...
        <div className="text-center">
          <p className="text-xs text-gray-600">
            3,000 requests remaining this month
          </p>
        </div>
      </div>
    </div>
